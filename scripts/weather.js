...
const getLocation=async(search)=>{
    let query=`https://dataservice.accuweather.com/locations/v1/cities/search?apikey=${key}&q=${search}`
...
const getWeather=async(search)=>{
   ...
   let query2=`https://dataservice.accuweather.com/currentconditions/v1/${cityKey}?apikey=${key}`
